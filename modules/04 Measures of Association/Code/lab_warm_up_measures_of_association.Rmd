...
Here is a matrix with character values. Remember, all elements of a vector must be of the same time (character, numeric, etc.), and a matrix _is_ a vector. So, all elements of a matrix must be of the same type.
...
Calculate our incidence risk differnce
